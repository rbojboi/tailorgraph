        ...
        <section className="panel rounded-[2rem] p-6">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row">
            ...
            <div className="max-w-3xl">
              <h1 className="mt-4 break-words text-3xl font-semibold text-stone-950 sm:text-4xl">{listing.title}</h1>
            ...
            <Link
              href={backHref}
              className="inline-flex min-h-11 max-w-full shrink-0 items-center justify-center self-start rounded-full border border-stone-300 bg-white px-4 py-2 text-center text-sm font-semibold text-stone-900"
            >
              {backLabel}
            </Link>
          </div>
