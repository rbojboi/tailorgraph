      ...
      <div className="pointer-events-none relative z-10 overflow-hidden rounded-[1.25rem] bg-stone-100">
        <div className="aspect-[4/5] w-full">
          {listing.media[0] ? (
            ...
            <ListingImage sizes="(max-width: 639px) calc(100vw - 64px), (max-width: 1023px) 45vw, 384px" src={listing.media[0].url} alt={listing.title} className="h-full w-full object-cover transition duration-300 hover:scale-[1.02]" />
          ) : (
